  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      <section
        ...
        aria-modal="true"
        aria-label={title}
        className="bab-sheet flex max-h-[54dvh] flex-col gap-2.5 overflow-y-auto border-t-[3px] border-[var(--color-ink)] bg-[var(--color-surface)] px-4 pb-[calc(env(safe-area-inset-bottom)+16px)] pt-3"
