...
--
-- I testi restano dove sono, dentro a `src/copy/`, compilati nell'app. Questa
-- tabella tiene solo cio' che qualcuno ha CAMBIATO dopo, dalla pagina
-- `/admin`. Tabella vuota = l'app dice quello che ha sempre detto, e ogni
-- scritta torna com'era togliendo la sua riga.
--
