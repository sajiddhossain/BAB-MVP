...
-- Le tre "when" entrano nella vista del coach: non sono testo libero, sono
-- risposte a scelta, e sono esattamente quello che serve per distinguere un
-- dolore che ha lavorato da uno che protegge.
